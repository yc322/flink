...
class SortPartitionITCase(mode: TestExecutionMode) extends MultipleProgramsTestBase(mode) {
  ...
  def testSortPartitionByKeyField(): Unit = {
    ...
    val result = ds
      ...
      .mapPartitionJ(new OrderCheckMapper(new Tuple3Checker))
      .distinct()
      .collect()
  ...
  def testSortPartitionByTwoKeyFields(): Unit = {
    ...
    val result = ds
      ...
      .mapPartitionJ(new OrderCheckMapper(new Tuple5Checker))
      .distinct()
      .collect()
  ...
  def testSortPartitionByNestedFieldExpression(): Unit = {
    ...
    val result = ds
      ...
      .sortPartition("_1._2", Order.ASCENDING)
        .sortPartition("_2", Order.DESCENDING)
      .mapPartitionJ(new OrderCheckMapper(new NestedTupleChecker))
      .distinct()
      .collect()
  ...
  def testSortPartitionPojoByNestedFieldExpression(): Unit = {
    ...
    val result = ds
      ...
      .mapPartitionJ(new OrderCheckMapper(new PojoChecker))
      .distinct()
      .collect()
  ...
  def testSortPartitionWithKeySelector1(): Unit = {
    ...
    val result = ds
      ...
      .mapPartitionJ(new OrderCheckMapper(new Tuple3AscendingChecker))
      .distinct()
      .collect()
