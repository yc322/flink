 ...
 */
@PublicEvolving
public class StreamingRuntimeContextNG extends AbstractRuntimeUDFContext {

	/** The operator to which this function belongs */
	private final StreamOperatorNG<?> operator;
	...
	/** For access to keyed state. This can be null, if the operator input is not keyed. */
	private final AbstractStateBackend stateBackend;

	public StreamingRuntimeContextNG(StreamOperatorNG<?> operator,
	...
	public <T> ValueState<T> getState(ValueStateDescriptor<T> stateProperties) {
		...
		try {
			...
			return stateBackend.getPartitionedState(null, VoidSerializer.INSTANCE, stateProperties);
		} catch (Exception e) {
