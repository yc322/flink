...
import org.apache.flink.streaming.api.functions.timestamps.ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractor;
...
/**
 * Tests for {@link ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractor}.
 */
public class ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractorTest {

	@Test
	public void testInitializationAndRuntime() {
		Time maxOutOfOrderness = Time.milliseconds(10L);
		Time idlenessDetectionDuration = Time.milliseconds(10L);
		Time processingTimeTrailingDuration = Time.milliseconds(10L);
		ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractor<Long> extractor =
			new LongExtractor(maxOutOfOrderness, idlenessDetectionDuration, processingTimeTrailingDuration);
	...
	public void testInitialFinalAndWatermarkUnderflow() {
		ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractor<Long> extractor =
			new LongExtractor(Time.milliseconds(10L), Time.milliseconds(10), Time.milliseconds(10));
	...
	private void runValidTests(ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractor<Long> extractor) {
	...
	private static class LongExtractor extends ProcessingTimeTrailingBoundedOutOfOrdernessTimestampExtractor<Long> {
		...
		public LongExtractor(
			...
			super(maxOutOfOrderness, idlenessDetectionDuration, processingTimeTrailingDuration);
		}
